...
<div class="main">
  <div class="topbar">
    ...
    <div class="badges">
      <span class="badge b-green">Laravel <?php echo e($laravelVersion); ?></span>
      <span class="badge b-blue">PHP <?php echo e($phpVersion); ?></span>
      <span class="badge b-amber"><?php echo e(strtoupper($dbDriver)); ?></span>
    </div>
  </div>
  ...
  <div class="content">
    ...
    <div id="dashboard" class="panel active">
      <div class="grid g5" style="margin-bottom:16px">
        ...
        <div class="card"><div class="stat"><?php echo e($userCount ?? 0); ?></div><div class="stat-label">Users</div></div>
        <div class="card"><div class="stat stat-blue"><?php echo e($repairCount ?? 0); ?></div><div class="stat-label">Repair Requests</div></div>
        <div class="card"><div class="stat stat-purple"><?php echo e($buildCount ?? 0); ?></div><div class="stat-label">PC Builds</div></div>
        <div class="card"><div class="stat stat-amber"><?php echo e($gigCount ?? 0); ?></div><div class="stat-label">Gigs</div></div>
      </div>
      <div class="grid g4">
        <div class="card"><h3>System</h3>
          <div style="font-size:12px;color:var(--muted)">
            <div style="display:flex;justify-content:space-between;padding:4px 0"><span>Laravel</span><span style="color:var(--text)"><?php echo e($laravelVersion); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:4px 0"><span>PHP</span><span style="color:var(--text)"><?php echo e($phpVersion); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:4px 0"><span>Environment</span><span class="badge b-amber" style="font-size:9px"><?php echo e($environment); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:4px 0"><span>Database</span><span style="color:var(--text)"><?php echo e(strtoupper($dbDriver)); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:4px 0"><span>Timezone</span><span style="color:var(--text)"><?php echo e($timezone); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:4px 0"><span>Cache</span><span style="color:var(--text)"><?php echo e($cacheDriver); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:4px 0"><span>Queue</span><span style="color:var(--text)"><?php echo e($queueDriver); ?></span></div>
          </div>
        </div>
        <div class="card"><h3>Users by Role</h3>
          <div style="font-size:12px;color:var(--muted)">
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Admins</span><span style="color:var(--red);font-weight:700"><?php echo e($adminCount ?? 0); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Technicians</span><span style="color:var(--blue);font-weight:700"><?php echo e($techCount ?? 0); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Customers</span><span style="color:var(--green);font-weight:700"><?php echo e($customerCount ?? 0); ?></span></div>
          </div>
        </div>
        <div class="card"><h3>Repairs</h3>
          <div style="font-size:12px;color:var(--muted)">
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Total</span><span style="color:var(--text);font-weight:700"><?php echo e($repairCount ?? 0); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Active</span><span style="color:var(--amber);font-weight:700"><?php echo e($activeRepairs ?? 0); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Completed</span><span style="color:var(--green);font-weight:700"><?php echo e($completedRepairs ?? 0); ?></span></div>
          </div>
        </div>
        <div class="card"><h3>Auth</h3>
          <div style="font-size:12px;color:var(--muted)">
            ...
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Active Tokens</span><span style="color:var(--text);font-weight:700"><?php echo e($tokenCount ?? 0); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Session</span><span style="color:var(--text)"><?php echo e($sessionDriver); ?></span></div>
    ...
    <div id="api-explorer" class="panel">
      ...
      <div class="card" style="padding:0;overflow:hidden">
        <table class="tbl" id="api-table">
          ...
          <tr class="api-row" data-method="<?php echo e($route['method'] ?? ''); ?>" data-uri="<?php echo e($route['uri'] ?? ''); ?>">
            <td><span class="m-<?php echo e(strtolower(explode('|', $route['method'] ?? '')[0])); ?>"><?php echo e($route['method'] ?? ''); ?></span></td>
            <td style="font-family:monospace;font-size:11px;color:var(--text)"><?php echo e($route['uri'] ?? ''); ?></td>
            <td style="font-size:11px"><?php echo e($route['action'] ?? ''); ?></td>
            <td style="font-size:10px"><?php echo e(is_array($route['middleware'] ?? null) ? implode(', ', $route['middleware']) : ($route['middleware'] ?? '—')); ?></td>
            <td style="font-size:10px;color:var(--accent)"><?php echo e($route['name'] ?? ''); ?></td>
            <td><button class="btn btn-sm btn-ghost" onclick='showApiDetail(<?php echo json_encode($route, 15, 512) ?>)'>Details</button></td>
          </tr>
    ...
    <div id="routes" class="panel">
      ...
      <div class="card" style="padding:0;overflow:hidden">
        <table class="tbl" id="routes-table">
          ...
          <tr class="route-row" data-search="<?php echo e(($route['method']??'').' '.($route['uri']??'').'. '.($route['name']??'')); ?>">
            <td><span class="m-<?php echo e(strtolower(explode('|', $route['method'] ?? '')[0])); ?>"><?php echo e($route['method'] ?? ''); ?></span></td>
            <td style="font-family:monospace;font-size:11px"><?php echo e($route['uri'] ?? ''); ?></td>
            <td style="font-size:10px;color:var(--accent)"><?php echo e($route['name'] ?? '—'); ?></td>
            <td style="font-size:11px"><?php echo e($route['action'] ?? ''); ?></td>
          </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <span class="code-k">"estimatedTime"</span>: <span class="code-s">"2-3 hours"</span>
    ...
    <div id="db-tables" class="panel">
      <div class="grid g3" style="margin-bottom:16px">
        ...
        <div class="card" style="cursor:pointer" onclick="showTable('<?php echo e($table); ?>')">
          <h3><?php echo e($table); ?></h3>
    ...
    <div id="server" class="panel">
      <div class="grid g3">
        <div class="card"><h3>PHP</h3><div class="stat"><?php echo e($phpVersion); ?></div><div class="stat-label">Version</div></div>
        <div class="card"><h3>Laravel</h3><div class="stat stat-blue"><?php echo e($laravelVersion); ?></div><div class="stat-label">Framework</div></div>
        <div class="card"><h3>Database</h3><div class="stat stat-purple"><?php echo e(strtoupper($dbDriver)); ?></div><div class="stat-label">Driver</div></div>
        <div class="card"><h3>Environment</h3><div class="stat stat-amber"><?php echo e($environment); ?></div><div class="stat-label">APP_ENV</div></div>
        <div class="card"><h3>Timezone</h3><div class="stat" style="font-size:18px"><?php echo e($timezone); ?></div><div class="stat-label">App Timezone</div></div>
        <div class="card"><h3>Server Time</h3><div class="stat" style="font-size:14px"><?php echo e($serverTime); ?></div><div class="stat-label">Current Time</div></div>
      </div>
    </div>
    ...
    <div id="health" class="panel">
      <div class="grid g2">
        <div class="card">
          ...
          <div class="health-item"><span class="health-dot <?php echo e($queueDriver === 'sync' ? 'dot-green' : 'dot-red'); ?>"></span>Queue<span style="margin-left:auto;color:<?php echo e($queueDriver === 'sync' ? 'var(--green)' : 'var(--red)'); ?>"><?php echo e($queueDriver === 'sync' ? '✔ Sync' : '⚠'); ?></span></div>
          <div class="health-item"><span class="health-dot dot-green"></span>Cache<span style="margin-left:auto;color:var(--green)">✔ <?php echo e($cacheDriver); ?></span></div>
        </div>
        <div class="card">
          <h3>Performance</h3>
          <div style="font-size:12px;color:var(--muted)">
            ...
            <div style="display:flex;justify-content:space-between;padding:8px 0;border-bottom:1px solid var(--border)"><span>Cache Driver</span><span style="color:var(--text)"><?php echo e($cacheDriver); ?></span></div>
            <div style="display:flex;justify-content:space-between;padding:8px 0"><span>Session Driver</span><span style="color:var(--text)"><?php echo e($sessionDriver); ?></span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="performance" class="panel">
      <div class="grid g4">
        <div class="card"><div class="stat stat-green"><?php echo e($tokenCount ?? 0); ?></div><div class="stat-label">Active Tokens</div></div>
        <div class="card"><div class="stat stat-blue"><?php echo e(count($tables ?? [])); ?></div><div class="stat-label">DB Tables</div></div>
        <div class="card"><div class="stat stat-purple"><?php echo e(count($routes ?? [])); ?></div><div class="stat-label">Registered Routes</div></div>
        <div class="card"><div class="stat stat-amber"><?php echo e(count($apiRoutes ?? [])); ?></div><div class="stat-label">API Endpoints</div></div>
      </div>
    </div>
    ...
    <div id="tokens" class="panel">
      <div class="card">
        ...
        <div style="margin-top:12px;font-size:12px;color:var(--muted)">
          ...
          <div style="display:flex;justify-content:space-between;padding:6px 0"><span>Total Issued</span><span style="color:var(--text);font-weight:700"><?php echo e($tokenCount ?? 0); ?></span></div>
        </div>
      </div>
    </div>
    ...
    <div id="logs" class="panel">
      <div class="card">
        ...
        <p style="font-size:11px;color:var(--dim)">Log channel: <?php echo e(config('logging.default', 'stack')); ?></p>
...
<?php /**PATH C:\Users\CORE\Desktop\0FYP\APP\backend-laravel\resources\views/demo.blade.php ENDPATH**/ ?>